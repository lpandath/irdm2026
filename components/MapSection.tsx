...
const locations = [
  ...
  {
    id: "schlossberg-restaurant",
    name: "Restaurant Schlossberg",
    category: "accommodation",
    position: [47.076389, 15.436746] as [number, number],
    description: "Workshop Dinner Location (to be confirmed)",
    details:
      "Am Schlossberg 7, 8010 Graz. Visit: https://www.schlossberggraz.at/",
    color: "#22c55e",
  },
  {
    id: "plaza-graz",
