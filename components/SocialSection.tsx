            ...
            <CardContent className="p-8">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    The restaurant offers great views over the city.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 pl-16">
                ...
                <div className="flex items-center gap-3 text-gray-700">
                  ...
                  <div>
                    ...
                    <div className="text-sm">Schlossberg</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 text-gray-700">
              ...
              <div className="mt-6 pl-16 pt-6 border-t border-gray-200">
                ...
                <p className="text-sm text-gray-700 mb-1">
                  <strong>Restaurant Schlossberg</strong>
                </p>
                ...
                <p className="text-sm text-gray-600">
                  <a
                    href="https://www.schlossberggraz.at/"
                    target="_blank"
